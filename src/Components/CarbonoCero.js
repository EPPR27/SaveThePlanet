    ...
    <div className="carbonoCero">
      ...
      <div className='container'>
        ...
        <p>
          ...
          <br /><br />
          <strong>Eficiencia energética y uso de fuentes renovables: </strong><br />
          ...
          <br /><br />
          <strong>Promoción de la movilidad sostenible:</strong><br />
          ...
          <br /><br />
          <strong>Gestión responsable de residuos:</strong><br />
          ...
          <br /><br />
          <strong>Compensación de emisiones:</strong><br />
          ...
          <br /><br />
          <strong>Monitoreo y divulgación:</strong><br />
          ...
          <br /><br />
          <strong>Participación y colaboración:</strong><br />
